...
function PDFindDoctor() {
    ...
    const addDoctor = async (userId) => {
        await FindDoctorViewModel.addDoctor(userId);
        fetchData();
                                            ...
                                            <>
                                                ...
                                                <ItemGroup
                                                    ...
                                                    items={[
                                                        <>
                                                            <InputBar
                                                                customClass='bg-neutral-1100 py-1 pr-1 pl-6 br-lg input-placeholder-font-4 input-text-placeholder-neutral-800 input-text-neutral-100 input-font-4 input-p-0 grid-bar'
                                                                onChange={(e) => {
