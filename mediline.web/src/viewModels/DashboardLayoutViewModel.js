...
class DashboardLayoutViewModel {
    ...
    splitDateTime(dateTime) {
        ...
        const formattedDate = this.convertToLocalISOString(dateObj).split("T")[0];

        // Extract time in "HH:MM" format
        const formattedTime = this.convertToLocalISOString(dateObj).split("T")[1].split("Z")[0].slice(0, 5);
